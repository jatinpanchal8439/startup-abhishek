...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Rankforge — SEO + AI Growth Studio" },
      { name: "description", content: "SEO, AI micro-SaaS, content & dev templates for ambitious tech brands." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Rankforge" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          sameAs: ["https://twitter.com/rankforge", "https://linkedin.com/company/rankforge"],
        }),
      },
    ],
  }),
